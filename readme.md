...
**list**: adds _list_, lists current commands and help for commands (currently disabled)  
...
**responses**: adds all the commands in _modules/responses_, see files in there for format  
