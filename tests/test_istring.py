...
from gbot.libs.girclib import IDict, IString


class IDictTestCase(unittest.TestCase):
    """Makes sure IDicts work properly."""
    def setUp(self):
        pass
    ...
    def test_equality_rfc(self):
        dic = IDict(std='rfc1459')

        dic['lOl'] = 3
        self.assertEquals(dic['LOl'], 3)

        dic['[37'] = 145
        self.assertEquals(dic['{37'], 145)
