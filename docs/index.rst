...
.. WARNING::
    ...
    If you can't program in Python, it may be best to use another well-proven IRC bot project that's less likely to break compatability. That said, if you do run into anything, please feel free to mail me at daniel@danieloaks.net or make an issue in the `Issue Tracker <https://github.com/DanielOaks/goshu/issues>`_.
