...
.. WARNING::
    Although I do try my best to not break things when working on Goshu, I'm not aware of anyone besides myself using it. Thus, I'm not as worried about breaking module interfaces and such in minor ways, because it's mostly me using the code and I can fix my own modules without issue.
