...
low level. It provides an -driven IRC client framework. It has
...
sslsock -- Enable support for ssl.
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    if DEBUG:
                        print("FROM SERVER IGNORED, UNKNOWN DATA ENCODING")
                    return
        except socket.error as x:
            # The server hung up.
...
"""
        self.connection.connect(server, port, nickname,
                                ...
                                localaddress, localport, sslsock, ipv6)
